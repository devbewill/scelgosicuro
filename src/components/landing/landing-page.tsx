...
// Warm:    #f8f2ea (hero, footer, some sections)
// Primary: #ff88c8 (buttons, accents, dots)
// Tint:    #ffe0f2 (badge/icon bg)
// Accents: sage #dbe1b0 / rose #eeb3b3 / greige #dad2c4
  ...
  return (
    <>
      ...
      <section className="bg-[#f8f2ea] relative overflow-hidden min-h-[680px] lg:min-h-[720px]">
        ...
        {/* pill grafiche — clippate a destra dal viewport */}
        <div
          ...
          <div className="bg-[#dad2c4] rounded-3xl p-5 md:p-6">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {[
                ...
                >
                  <div className="w-2 h-2 rounded-full bg-[#ff88c8] flex-shrink-0" />
      ...
      {/* ── CTA BAND — bg pink ───────────────────────────────────────────── */}
      <section className="bg-[#ff88c8] relative overflow-hidden">
        <div
          className="absolute pointer-events-none"
          style={{
            top: "-50%",
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 py-20 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-8 relative z-10">
          ...
          <Link
            href="/app"
            className="bg-white text-[#1C1C1A] font-semibold px-8 py-4 rounded-full text-base transition-all duration-200 hover:-translate-y-px hover:shadow-[0_8px_30px_rgba(0,0,0,0.15)] flex-shrink-0 whitespace-nowrap"
          >
            Calcola il preventivo →
          </Link>
        </div>
